      ...
      body:Column(
        ...
        children: [
          ...
          child: SvgPicture.asset(
                            ...
                            color: HexColor('#608795'),
                            matchTextDirection: true,
                          ),
        ),
        title: getRegularText("I'm in a rounding. Call you soon.",textColor: AppColor.black,fontSize: 16),
        trailing: 
         Padding(
          padding:  EdgeInsets.only(right:AppSize().width(context)*0.06),
          child:
           SvgPicture.asset(
                            'assets/images/edit.svg',
                            color: HexColor('#CBE0E8'),
                            matchTextDirection: true,
                          ),
        ),
          ),
        ...
        title: getRegularText("I'm out of the hospital. Call you when I get back.",textColor: AppColor.black,fontSize: 16),
        trailing: 
         Padding(
          padding:  EdgeInsets.only(right:AppSize().width(context)*0.06),
          child:
        ...
        title: getRegularText("May I help you?",textColor: AppColor.black,fontSize: 16),
        trailing: 
         Padding(
          padding:  EdgeInsets.only(right:AppSize().width(context)*0.06),
          child:
        ...
        title: getRegularText("I'm in meeting. Call you soon",textColor: AppColor.black,fontSize: 16),
        trailing: 
         Padding(
          padding:  EdgeInsets.only(right:AppSize().width(context)*0.06),
          child:
        ...
        title: getRegularText("I'm Busy",textColor: AppColor.black,fontSize: 16),
        trailing: 
         Padding(
          padding:  EdgeInsets.only(right:AppSize().width(context)*0.06),
          child:
