...
//   }
//
//   _renderBottomMenuItem(icon, title, {required FileType type}) {
...
//         //   selectedFile = await FilePicker.platform.getFile(type: FileType.video);
//         // } else
//           if (type == FileType.image) {
//           selectedFile = await FilePicker.platform.pickFiles(type: FileType.image);
//           PlatformFile file = selectedFile!.files.first;
//           picksfile = File(selectedFile!.files.single.path!);
//           // file=File(selectedFile!.paths);
//         }
//       },
//     );
//   }
...
//           file: picksfile,
//           fileNameWithExt: 'abc',
//           poolId: 'us-east-2_MitL8C608',
//           region: Regions.US_EAST_2,
//           bucketName: 'securetext');
//
...
//     await _uploadImage(picksfile, 1);
//
